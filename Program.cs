...
//    //if (tag == "/html")
//    if (tag.StartsWith("/") && !HtmlHelper.Instance.HtmlVoidTags.Contains(tag))
//    {
//        break;
//    }
...
//Selector s =Selector.ConvertQueryToSelector("div");
//root.FindElementsBySelector(s).ForEach(x => Console.WriteLine(x.Name));
...
PrintTree(root);
Selector s = Selector.ConvertQueryToSelector("div div img.logo");
//Selector s = Selector.ConvertQueryToSelector("link");
foreach (var item in root.FindElementsBySelector(s))
{
